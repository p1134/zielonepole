...
<!-- Baner i opis -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6" style="height: auto; display: grid; justify-content: start; padding-top: 300px;">
                        <section>
                            <a href="rezerwacja_wybor.php" style="color: white; text-decoration: none;"><button type="button" class="btn btn-outline-* przycisk-rezerwuj" style="font-size: 50px; border-radius: 20px; padding: 20px 80px 20px 80px;">REZERWUJ</button></a>
                        </section>
                    </div>
        ...
        <div class="col-md-3 cc1">
            ...
            <a href="" data-toggle="modal" data-target="#rezerwacja_namiot"><img src="Grafiki/tent.svg" style="width: 150px; margin-top: 45px;" class="ikona"></a>
            </section>
        </div>
        <div class="col-md-3 cc1">
            <section class="kwadrat1">
            <a href="" data-toggle="modal" data-target="#rezerwacja_kamper"><img src="Grafiki/camper.svg" style="width: 150px; margin-top: 45px;" class="ikona"></a>
            </section>
        </div>
        <div class="col-md-3 cc1">
            <section class="kwadrat1">
            ...
            <div class="row" style="margin-top: 70px;">
                <div class="col-md-6">
                    <ul class="list-group">
                      ...
                      <li class="list-group-item d-flex justify-content-center align-items-center">
                          <a data-toggle="modal" data-target="#rezerwacja_namiot" style="text-decoration: none; color: white;"><button type="button" class="btn btn-outline-* rez_cennik" style="font-size: 20px; border-radius: 20px; padding: 7px 30px 7px 30px;">REZERWUJ</button></a>
                ...
                <div class="col-md-6">
                    <ul class="list-group">
                      ...
                      <li class="list-group-item d-flex justify-content-center align-items-center">
                          <a data-toggle="modal" data-target="#rezerwacja_kamper" style="text-decoration: none; color: white;"><button type="button" class="btn btn-outline-* rez_cennik" style="font-size: 20px; border-radius: 20px; padding: 7px 30px 7px 30px;">REZERWUJ</button></a>
        ...
        <div class="container" style="margin-top: 40px; padding-bottom: 30px;">
            <div class="row">
                ...
                <div class="col-sm-4 stopka_linki" style="line-height: 22px; padding-top: 20px; padding-left: 100px;">
                    ...
                    <a href="rezerwacja_wybor.php" class="stopka_zielony">Rezerwacja</a><br>
