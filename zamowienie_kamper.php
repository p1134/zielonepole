...
<div class="container" style="height: 70vh;">
    <div class="row">
        <div class="col-md-5">
            ...
            <div class="row" style="height: 30vh;">
                <div class="col-md-12">
                  <a class="nav-link namiot-wybor" href="" data-toggle="modal" data-target="#rezerwacja_kamper" style="font-family: 'Concert One', cursive; color: black; text-align: center; font-size: 50px; text-decoration: none; "><p>NAMIOT</p></a>
                </div>
            </div>
        </div>
...
$rodzaj = "kamper";
$sektorA = $_POST['sektorA'];
$sektorC = $_POST['sektorC'];
$sektorJ = $_POST['sektorJ'];
$razemA = 30 * $sektorA;
$razemC = 35 * $sektorC;
$razemJ = 40 * $sektorJ;
$suma = $razemA + $razemC + $razemJ;
    
$sql = "INSERT INTO Rezerwacje (user, rodzaj, sektorA_doby,sektorB_doby, sektorC_doby,sektorD_doby, sektorE_doby, sektorG_doby, sektorH_doby, sektorJ_doby, koszt) VALUES ('$login', '$rodzaj','$sektorA', '0', '$sektorC','0','0', '0', '0', '$sektorJ', '$suma')";
...
<div class="modal fade" id="zamowienie_kamper" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
                    ...
                    <ul class="list-group" style="padding-top: 20px;">
                      ...
                      <li class="list-group-item d-flex justify-content-between align-items-center">
                        <div class="container">
                          <div class="row">
                            ...
                            <div class="col-md-4" style="display: grid; justify-content: center;">
                            <span class="badge badge-primary badge-pill" style="background-color: #2a2c2b; font-size: 15px;"><?php echo "$razemA PLN" ?></span>
                              </div>
                            </div>
                          </div>
                      </li>
                      ...
                      <li class="list-group-item d-flex justify-content-between align-items-center">
                        <div class="container">
                          <div class="row">
                            ...
                            <div class="col-md-4" style="display: grid; justify-content: center;">
                            <span class="badge badge-primary badge-pill" style="background-color: #2a2c2b; font-size: 15px;"><?php echo "$razemC PLN" ?></span>
                              </div>
                            </div>
                          </div>
                      </li>
                      <li class="list-group-item d-flex justify-content-between align-items-center">
                        <div class="container">
                          <div class="row">
                            ...
                            <div class="col-md-4" style="display: grid; justify-content: center;">
                            <span class="badge badge-primary badge-pill" style="background-color: #2a2c2b; font-size: 15px;"><?php echo "$razemJ PLN" ?></span>
                              </div>
                            </div>
                          </div>
                      </li>
                      ...
                      <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <section style="display: grid; justify-content: center; padding-top: 20px;">
                            <button type="button" class="btn btn-outline-* rez_podsumowanie" style="font-size: 20px; border-radius: 20px; padding: 5px 30px 5px 30px;"><a class="rez_podsumowanie" href="zalogowany.php" style="text-decoration: none;">REZERWUJ</a></button>
                      </section>
                    </section>
